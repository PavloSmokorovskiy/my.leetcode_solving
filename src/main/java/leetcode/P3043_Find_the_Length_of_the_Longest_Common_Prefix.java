...
public class P3043_Find_the_Length_of_the_Longest_Common_Prefix {
    ...
    public static void main(String[] args) {
        int[] arr1 = new int[]{1, 10, 100}, arr2 = {1000};
        System.out.println(new P3043_Find_the_Length_of_the_Longest_Common_Prefix().longestCommonPrefix(arr1, arr2));
    }
