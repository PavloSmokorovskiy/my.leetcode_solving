...
//        System.out.println("Exp: 12: " + res2);
    ...
    private long maximumBooksFast(int[] books) {
        int n = books.length;
        int[] left = new int[n];
        ...
        for (int i = 0; i < n; i++) {
            while (top != -1 && books[stack[top]] - stack[top] >= books[i] - i) top--;
    ...
    private long maximumBooksMedium(int[] books) {
    ...
    private long maximumBooksBruteForce(int[] books) {
