...
public class P1431_Kids_With_the_Greatest_Number_of_Candies {
    ...
    public static void main(String[] args) {
        ...
        var extraCandies = 3;
        List<Boolean> res = new P1431_Kids_With_the_Greatest_Number_of_Candies().kidsWithCandies(candies, extraCandies);
    ...
    public List<Boolean> kidsWithCandies(int[] candies, int extraCandies) {
        ...
        return Arrays.stream(candies).mapToObj(num -> num + extraCandies >= max).toList();
    }
}
